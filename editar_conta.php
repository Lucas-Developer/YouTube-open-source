...
<body>
	<div id="loading">
		<div id="cor"></div>
		<p>A editar conta atual ...</p>
	</div>
	<p id="aviso">Atenção, as fotos serão carregadas assim que as alterações forem guardadas</p>
	...
	<form method="POST" name="editar" id="editar">
		...
		<input type="password" name="password" placeholder="Nova palavra-passe (opcional)" id="field" />
		<input type="submit" id="insc" name="editarConta" value="Guardar alterações" />
	</form>
