...
<body>
	...
	<?php
		...
		if ($id==$user_id) {
			?>
			<button id="insc" onclick="location.href = 'editar_conta.php'">Editar a minha conta (<?php echo mysql_num_rows($count); ?> subscritores)</button>
			<?php
		}elseif ($log=="nao") {
			?>
			<button id="insc" onclick="logar();"><?php echo mysql_num_rows($count); ?> subscritores</button>
			<?php
		}elseif (mysql_num_rows($get)>0) {
			?>
			<button id="insc" onclick="subscrever()">Subscrito (<?php echo mysql_num_rows($count); ?> subscritores)</button>
			<?php
		}else{
			?>
			<button id="insc" onclick="subscrever()">Subscrever (<?php echo mysql_num_rows($count); ?> subscritores)</button>
			<?php
		}
		echo "</div>";
