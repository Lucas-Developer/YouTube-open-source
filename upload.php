...
<body>
	...
	<form method="POST" name="upload" id="editar" enctype="multipart/form-data">
		...
		<label for="file" id="btn">Selecionar um vídeo</label>&nbsp;&nbsp;<label for="file2" id="btn">Selecionar uma thumnail</label>
		<input type="text" name="titulo" placeholder="Título do vídeo..." id="field" />
		<textarea placeholder="Descrição" name="descricao" maxlength="1000"></textarea>
