...
<body>
	...
	<p id="desc"><strong>Descrição</strong><br /><br /><?php echo $info['descricao']; ?></p>
	<div id="comentarios">
		<strong>Comentários</strong><br /><br />
		<?php
			if ($log=="sim") {
				?><form method="POST" name="comentar"><textarea name="texto" placeholder="Escrever comentário..." maxlength="500"></textarea><input type="submit" name="comentar" value="Comentar"></form><?php
			}
